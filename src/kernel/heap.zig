...
pub const FreeListAllocator = struct {
    ...
    fn insertFreeHeader(at: usize, size: usize, next_free: ?*Header) *Header {
        const node = @as(*Header, @ptrFromInt(at));
    ...
    test "init" {
        ...
        const header = @as(*FreeListAllocator.Header, @ptrFromInt(@intFromPtr(region.ptr)));
    ...
    test "alloc" {
        ...
        var header = @as(*Header, @ptrFromInt(start + 64));
        ...
        const second_header = @as(*Header, @ptrFromInt(alloc2_end));
        ...
        const header2 = @as(*Header, @ptrFromInt(alloc3_end));
    ...
    test "free" {
        ...
        const free_node3 = @as(*Header, @ptrFromInt(@intFromPtr(alloc2.ptr) + alloc2.len));
        ...
        const free_node0 = @as(*Header, @ptrFromInt(start));
    ...
    test "resize" {
        ...
        var header = @as(*Header, @ptrFromInt(@intFromPtr(alloc1.ptr) + 512));
