...
pub fn lgic(gic_ptr: *const gic.gicPtr) void {
    return mock_framework.performAction("lgic", void, .{gic_ptr});
}

pub fn sgic() gic.gicPtr {
    return mock_framework.performAction("sgic", gic.gicPtr, .{});
}
