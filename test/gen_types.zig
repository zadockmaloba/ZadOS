...
const types = .{
    ...
    .{ "gicPtr", "gicPTR", "gic_mock", "", "gicPtr" },
    .{ "*const GdtPtr", "PTR_CONST_GDTPTR", "gdt_mock", "", "GdtPtr" },
    .{ "*const gicPtr", "PTR_CONST_gicPTR", "gic_mock", "", "gicPtr" },
    .{ "*Allocator", "PTR_ALLOCATOR", "", "std.mem", "Allocator" },

    .{ "gicError!void", "ERROR_gicERROR_RET_VOID", "gic_mock", "", "gicError" },
    ...
    .{ "fn (gicEntry) bool", "FN_IgicENTRY_OBOOL", "gic_mock", "", "gicEntry" },
    .{ "fn (*const GdtPtr) anyerror!void", "FN_IPTRCONSTGDTPTR_EERROR_OVOID", "", "", "" },
    .{ "fn (*const gicPtr) anyerror!void", "FN_IPTRCONSTgicPTR_EERROR_OVOID", "", "", "" },
    .{ "fn (*const GdtPtr) void", "FN_IPTRCONSTGDTPTR_OVOID", "", "", "" },
    .{ "fn (*const gicPtr) void", "FN_IPTRCONSTgicPTR_OVOID", "", "", "" },

    .{ "fn (u4, u4) u8", "FN_IU4_IU4_OU8", "", "", "" },
    .{ "fn (u8, u8) u16", "FN_IU8_IU8_OU16", "", "", "" },
    .{ "fn (u8, fn () callconv(.Naked) void) gicError!void", "FN_IU8_IFNCCNAKEDOVOID_EgicERROR_OVOID", "", "", "" },
